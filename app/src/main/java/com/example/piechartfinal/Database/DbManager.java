...
public class DbManager {
    ...
    private static class DbHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL(DbSchema.Table_Spinner.CREATE_TABLE);
            db.execSQL(DbSchema.Table_Dates.CREATE_TABLE);
        }

        @Override
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            db.execSQL(DbSchema.Table_Spinner.DROP_TABLE);
            db.execSQL(DbSchema.Table_Dates.DROP_TABLE);
            this.onCreate(db);
        }
